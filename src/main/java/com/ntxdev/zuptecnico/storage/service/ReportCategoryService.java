...
public class ReportCategoryService extends BaseService {
    ...
    public void setReportCategoryIcon(int id, Bitmap image) {
        setBitmap("report_category_icon_" + id, image);
    }

    public Bitmap getReportCategoryIcon(int id) {
        return getBitmap("report_category_icon_" + id);
    }
